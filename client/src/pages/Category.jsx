...
export default function Category() {
  ...
  async function fetchProducts(){
    const data = await (await axios.get(`https://maddkit.com/wp-json/wc/v3/products?category=${catId}&per_page=50&consumer_key=ck_b0889e799c2d297ce09848972be70e5316b2bee7&consumer_secret=cs_68bfdeba8afd2aae06dab5816ac7088d0e6586bf`)).data;
    setProducts(data)
  }
